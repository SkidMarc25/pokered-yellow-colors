...
ItemDescriptionPointers:
	...
	text_end
	text_far _LinkStoneItemDescription
	text_end
	...
	text_end
	text_far _SunStoneItemDescription
	text_end
...
;	text_end
;	text_far _TM57Description
;	text_end
;	text_far _TM58Description
;	text_end
;	text_far _TM59Description
;	text_end
;	text_far _TM60Description
;	text_end