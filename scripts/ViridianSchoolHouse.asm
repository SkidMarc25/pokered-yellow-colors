...
ViridianSchoolHouse_TextPointers:
	...
	dw_const ViridianSchoolHouseYoungsterText, TEXT_VIRIDIANSCHOOLHOUSE_YOUNGSTER
...
ViridianSchoolHouseYoungsterText:
	text_far _ViridianSchoolHouseYoungsterPreDexText
	text_end
