...
TangelaEvosMoves:
; Evolutions
	db EVOLVE_ITEM, SUN_STONE, 1, TANGROWTH
	db 0
; Learnset
	db 14, ABSORB
	db 18, BIND
...
OnixEvosMoves:
; Evolutions
	db EVOLVE_ITEM, LINK_STONE, 1, STEELIX
	db 0
; Learnset
	db 14, ROCK_THROW
	db 18, RAGE
...
MagmarEvosMoves:
; Evolutions
	db EVOLVE_ITEM, LINK_STONE, 1, MAGMORTAR
	db 0
; Learnset
	db 15, LEER
	db 21, SMOG
...
ElectabuzzEvosMoves:
; Evolutions
	db EVOLVE_ITEM, LINK_STONE, 1, ELECTIVIRE
	db 0
; Learnset
	db 15, LEER
	db 21, SWIFT
...
SeadraEvosMoves:
; Evolutions
	db EVOLVE_ITEM, LINK_STONE, 1, KINGDRA
	db 0
; Learnset
	db 10, SMOKESCREEN
	db 17, LEER
...
GolbatEvosMoves:
; Evolutions
	db EVOLVE_ITEM, SUN_STONE, 1, CROBAT
	db 0
; Learnset
	db 10, SUPERSONIC
	db 15, BITE
...
PorygonEvosMoves:
; Evolutions
	db EVOLVE_ITEM, LINK_STONE, 1, PORYGON2
	db 0
; Learnset
	db 13, SHARPEN
	db 18, THUNDERSHOCK
