...
BrunoData:
	db $FF, 53, POLIWRATH, 55, HITMONCHAN, 55, HITMONLEE, 56, ONIX, 58, MACHAMP, 0

BrockData:
	db $FF, 12, GEODUDE, 14, ONIX, 0

MistyData:
	db $FF, 18, HORSEA, 20, PSYDUCK, 21, STARMIE, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, MAGNEMITE, 24, RAICHU, 0

ErikaData:
	db $FF, 26, TANGELA, 24, WEEPINBELL, 25, IVYSAUR, 29, VILEPLUME, 0

KogaData:
	db $FF, 37, GOLBAT, 39, MUK, 37, WEEZING, 43, VENOMOTH, 0

BlaineData:
	db $FF, 42, FLAREON, 44,MAGMAR, 42, RAPIDASH, 47, ARCANINE, 0

SabrinaData:
	db $FF, 38, MR_MIME, 37, EXEGGUTOR, 38, KADABRA, 43, ALAKAZAM, 0
