...
BrunoData:
	...
	;db $FF, 53, HITMONCHAN, 55, PINSIR, 55, HITMONLEE, 56, ONIX, 55, POLIWRATH, 58, MACHAMP, 0 ; Challenge Mode
...
ErikaData:
	...
	;db $FF, 23, EXEGGCUTE, 24, VICTREEBEL, 20, SCYTHER, 19, BUTTERFREE, 24, TANGELA, 0 ; Challenge Mode - Scyther is Lurantis

KogaData:
	db $FF, 37, GOLBAT, 39, MUK, 37, WEEZING, 43, VENOMOTH, 0
	;db $FF, 23, WEEZING, 20, MUK, 19, HYPNO, 24, TENTACRUEL, 45, GOLBAT, 0 ; Challenge Mode - Golbat is Crobat

BlaineData:
	db $FF, 42, FLAREON, 40, MAGMAR, 42, RAPIDASH, 47, ARCANINE, 0
	;db $FF, 23, ARCANINE, 20, GOLEM, 19, NINETALES, 24, RAPIDASH, 50, MAGMAR, 0 ; Challenge Mode - Magmar is Magmortar

SabrinaData:
	db $FF, 38, KADABRA, 37, MR_MIME, 38, EXEGGUTOR, 43, EEVEE, 0 ; Eevee is Espeon
	;db $FF, 23, EEVEE, 20, VENOMOTH, 19, EXEGGUTOR, 24, GOLDUCK, 50, ALAKAZAM, 0 ; Challenge Mode - Eevee Is Espeon
...
LoreleiData:
	...
	;db $FF, 54, EEVEE, 52, KINGLER, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 0 ;Challenge Mode - Eevee is Glaceon
...
AgathaData:
	...
	;db $FF, 56, ARBOK, 56, MISDREAVUS, 55, EEVEE, 58, NINETALES, 59, MAROWAK, 60, GENGAR, 0 ; Challenge Mode - Eevee is Umbreon

LanceData:
	db $FF, 58, GYARADOS, 56, DRAGONAIR, 56, DRAGONAIR, 60, AERODACTYL, 62, DRAGONITE, 0
	;db $FF, 58, GYARADOS, 56, ARCANINE, 56, SEADRA, 60, AERODACTYL, 59, GOLBAT, 62, DRAGONITE, 0 ; Challenge Mode - Golbat is Noivern
