...
ViridianCity_Object:
	...
	warp_event 10,  9, VIRIDIAN_SCHOOL_HOUSE, 1
	...
	bg_event 13, 13, TEXT_VIRIDIANCITY_SCHOOL_SIGN

	def_object_events
	object_event  9, 17, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER1
	object_event 29,  6, SPRITE_GAMBLER, STAY, NONE, TEXT_VIRIDIANCITY_GAMBLER1
	object_event 30, 23, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER2
