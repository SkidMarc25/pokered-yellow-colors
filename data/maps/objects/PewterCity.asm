...
PewterCity_Object:
	...
	warp_event  7, 27, PEWTER_SPEECH_HOUSE, 1
	warp_event 13, 25, PEWTER_POKECENTER, 1
	warp_event 16, 31, ROUTE_2_GATE, 2
	warp_event 17, 31, ROUTE_2_GATE, 2
	...
	def_object_events
	object_event  5, 12, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_F
	object_event 12, 28, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_M
