...
SaffronCity_Object:
	...
	warp_event 31,  3, SAFFRON_GYM, 1
	warp_event  9, 11, SAFFRON_PIDGEY_HOUSE, 1
	warp_event 25, 11, SAFFRON_MART, 1
	warp_event 17, 21, SILPH_CO_1F, 1
	warp_event  9, 29, SAFFRON_POKECENTER, 1
	warp_event 27, 27, MR_PSYCHICS_HOUSE, 1
	...
	bg_event 25, 27, TEXT_SAFFRONCITY_MR_PSYCHICS_HOUSE_SIGN
	...
	object_event 31,  4, SPRITE_ROCKET, STAY, NONE, TEXT_SAFFRONCITY_ROCKET3
	object_event  9, 12, SPRITE_ROCKET, STAY, NONE, TEXT_SAFFRONCITY_ROCKET4
	object_event  9, 24, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_ROCKET5
	object_event 33, 13, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_ROCKET6
	object_event 23, 29, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_ROCKET7
	object_event  5, 10, SPRITE_SCIENTIST, WALK, ANY_DIR, TEXT_SAFFRONCITY_SCIENTIST
	object_event 24, 22, SPRITE_SILPH_WORKER_M, STAY, NONE, TEXT_SAFFRONCITY_SILPH_WORKER_M
	object_event 18, 29, SPRITE_SILPH_WORKER_F, WALK, LEFT_RIGHT, TEXT_SAFFRONCITY_SILPH_WORKER_F
	object_event 27, 12, SPRITE_GENTLEMAN, STAY, DOWN, TEXT_SAFFRONCITY_GENTLEMAN
	object_event 28, 12, SPRITE_BIRD, STAY, DOWN, TEXT_SAFFRONCITY_PIDGEOT
	object_event 18,  8, SPRITE_ROCKER, STAY, UP, TEXT_SAFFRONCITY_ROCKER
	object_event 17, 22, SPRITE_ROCKET, STAY, DOWN, TEXT_SAFFRONCITY_ROCKET8
	object_event 18, 22, SPRITE_ROCKET, STAY, DOWN, TEXT_SAFFRONCITY_ROCKET9
