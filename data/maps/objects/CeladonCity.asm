...
CeladonCity_Object:
	...
	def_warp_events
	warp_event  7, 13, CELADON_MART_1F, 1
	warp_event 10, 13, CELADON_MART_1F, 3
	warp_event 23,  9, CELADON_MANSION_1F, 1
	...
	def_bg_events
	bg_event  3, 25, TEXT_CELADONCITY_TRAINER_TIPS1
	bg_event 35, 12, TEXT_CELADONCITY_SIGN
	bg_event 42,  9, TEXT_CELADONCITY_POKECENTER_SIGN
	bg_event 11, 28, TEXT_CELADONCITY_GYM_SIGN
	...
	def_object_events
	object_event 14, 21, SPRITE_LITTLE_GIRL, WALK, ANY_DIR, TEXT_CELADONCITY_LITTLE_GIRL
	object_event 12, 28, SPRITE_GRAMPS, STAY, UP, TEXT_CELADONCITY_GRAMPS1
	object_event  7, 18, SPRITE_GIRL, WALK, UP_DOWN, TEXT_CELADONCITY_GIRL
	object_event 26, 22, SPRITE_GRAMPS, STAY, DOWN, TEXT_CELADONCITY_GRAMPS2
	object_event 22, 18, SPRITE_GRAMPS, STAY, DOWN, TEXT_CELADONCITY_GRAMPS3
	object_event 19, 10, SPRITE_FISHER, STAY, LEFT, TEXT_CELADONCITY_FISHER
	object_event 17, 10, SPRITE_MONSTER, STAY, RIGHT, TEXT_CELADONCITY_POLIWRATH
	object_event 32, 29, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_CELADONCITY_ROCKET1
	object_event 30, 13, SPRITE_ROCKET, WALK, LEFT_RIGHT, TEXT_CELADONCITY_ROCKET2
