...
ViridianSchoolHouse_Object:
	...
	object_event  0,  2, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_VIRIDIANSCHOOLHOUSE_YOUNGSTER
	object_event  4,  1, SPRITE_GENTLEMAN, STAY, DOWN, TEXT_VIRIDIANSCHOOLHOUSE_COOLTRAINER_F
