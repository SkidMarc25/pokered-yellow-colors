...
; Characteristics of each move.
	...
	move CUT,          NO_ADDITIONAL_EFFECT,        60, NORMAL,        95, 30
	...
	move DISABLE,      DISABLE_EFFECT,               0, NORMAL,        65, 20
	...
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        45, ROCK,          95, 15
	...
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  25, NORMAL,       100, 15
	...
	move GLARE,        PARALYZE_EFFECT,              0, NORMAL,        80, 30
	...
	move MUD_SLAP,     SPEED_DOWN_SIDE_EFFECT,      30, GROUND,       100, 15
	move POISON_JAB,   POISON_SIDE_EFFECT2,         80, POISON,       100, 10
	move ROCK_TOMB,    SPEED_DOWN_SIDE_EFFECT,      60, ROCK,         100, 10
	move LUNGE,        ATTACK_DOWN_SIDE_EFFECT,     80, BUG,          100, 10
	move SILVER_WIND,  NO_ADDITIONAL_EFFECT,        60, BUG,          100,  5
	move METAL_CLAW,   DEFENSE_DOWN_SIDE_EFFECT,    50, STEEL,        100, 15
	move IRON_DEFENSE, DEFENSE_UP2_EFFECT,           0, STEEL,        100, 10
	move IRON_TAIL,    DEFENSE_DOWN_SIDE_EFFECT,   100, STEEL,         75,  5
	move MAGNET_BOMB,  SWIFT_EFFECT,                60, STEEL,        100, 15
	move FAIRY_WIND,   NO_ADDITIONAL_EFFECT,        40, FAIRY,        100, 20
	move SWEET_KISS,   CONFUSION_EFFECT,             0, FAIRY,        100, 15
	move DAZZLE,       NO_ADDITIONAL_EFFECT,        80, FAIRY,        100, 10
	move FEINT_ATTACK, SWIFT_EFFECT,                60, DARK,         100, 15
	move DRAGON_CLAW,  NO_ADDITIONAL_EFFECT,        80, DRAGON,       100, 10
